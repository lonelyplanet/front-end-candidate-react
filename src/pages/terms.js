  ...
  render() {
    return (
      <div>
        ...
        <h2 style={{textAlign: "center", paddingTop: "5%", fontSize: "80px"}}>Legal</h2>
        ...
        <table >
          <tr>
            <td style={{width: "69%", verticalAlign: "top", fontSize: "10px"}}>
                    Customer Privacy Policy
Introduction
Company, Inc. and its affiliates (“Company”) respect your concerns about privacy. This Privacy Policy explains Company’s policies and procedures regarding information we collect from or about our customers and their use of our products and services. Company intends to provide you with a level of comfort and confidence in how we collect, use, share, and safeguard information that we collect. This Privacy Policy also explains how you can contact us if you have any questions or concerns. By providing information to us or by using our products or services, you agree to the terms and conditions of this Privacy Policy.
Information We May Collect
We collect three main types of information related to you or your use of our products and services: (1) information from or about you or your devices; (2) information from or about your Company vehicle; and (3) information from or about your Company energy products. Depending on the Company products and services you request, own, or use, not all of these types of information may be applicable to you.
...
	Company Account: Customers who purchase certain Company products will receive a Company Account, which is hosted on our website. We may collect and process the following types of data for your Company Account that you elect to provide to us: your customer registration information; the status of your order; warranty and other documentation for your Company products; and general information about your Company products (including, for example, vehicle identification number or other product serial number, service plan information, or connectivity package), insurance forms, driver’s licenses, financing agreements, and similar information. You can access your Company Account to update the information from or about you in that account at any time.
	Offline: We may collect information from or about you offline, such as when you visit a Company store or repair facility, attend one of our events, sign up for a test drive, place an order over the phone, or contact our customer service or sales department.
	Through your browser or device: Certain information is collected by most browsers or automatically through your device, such as your Media Access Control (MAC) address, computer type (Windows or Macintosh), screen resolution, operating system name and version, device manufacturer and model, language, Internet browser type and version, and the name and version of the Digital Services (such as the Company App) you are using. We use this information to ensure that the Digital Services function properly.
...
If you no longer wish us to collect telematics log data or any other data from your Company vehicle, please contact us as indicated in the “How to Contact Us” section below. Please note that if you opt out from the collection of telematics log data or any other data from your Company vehicle (with the exception of the Data Sharing setting detailed above), we will not be able to notify you of issues applicable to your vehicle in real time. This may result in your vehicle suffering from reduced functionality, serious damage, or inoperability, and it may also disable many features of your vehicle including periodic software and firmware updates, remote services, and interactivity with mobile applications and in-car features such as location search, Internet radio, voice commands, and web browser functionality.
From or about your Company energy products
We may collect a variety of information from or about your Company energy products or your home from you, via a certified installer when one of our energy advisers visits your home, from your electric utility, or from the installed products (directly or via paired equipment, such as an inverter), including:
...
If you no longer wish us to collect performance data or any other data from your Company energy product, please contact us as indicated in the “How to Contact Us” section below. Please note that if you opt out from the collection of performance data from your Company energy product, we will not be able to notify you of issues applicable to your energy product in real time. This may result in your energy product suffering from reduced functionality, serious damage, or inoperability, and it may also disable many features of your energy product including periodic software and firmware updates.
...
	To set up, evaluate, and provide feedback regarding your Company test drive, a home visit by one of our energy advisers, or the installation of your energy product.
...
	To provide service to your Company product, such as to contact you with service recommendations and to deliver over-the-air updates to your product.
	To monitor your Company product’s performance and provide services related to your product.
...
	Except as described above and below, Company may use or share information that does not personally identify you for any purpose, such as for operational or research purposes, for industry analysis, to improve or modify our products and services, to better tailor our products and services to your needs, and where legally required.
...
	With Company affiliates for the purposes described in this Privacy Policy. Company affiliates are companies that are owned or controlled by Company, Inc. and companies in which Company, Inc. has a substantial ownership interest.
	With our third party service providers and channel partners to provide services such as website hosting, data analysis and storage, payment processing, order fulfillment and product installation, wireless connectivity to Company products, information technology and related infrastructure, customer service, product design, product diagnostics, maintenance or related services, e-mail delivery, credit card processing, auditing, marketing, voice command processing, and other similar services.
	With other third party business partners to the extent that they are involved in the purchase, lease, or service of your Company products. We share limited information from or about you or your Company products to allow you to take advantage of those services if you elect to utilize them, with such partners as finance, leasing, registration, title companies, electric utilities, permitting authorities and insurance companies.
...
	With third party service centers or providers, if you choose to utilize them. Note that some information about you is stored on certain Company products and may be accessible directly to the third party service centers or providers that you choose to utilize to diagnose or service your Company product.
	With third-party sponsors of contests and similar promotions, if you elect to participate.
	With your social media account provider, if you connect your Company Account and your social media account. If you do so, you authorize us to share information with your social media account provider and you understand that the use of the information we share will be governed by the social media account provider’s privacy policy.
With other third parties when required by law
Company may transfer and disclose information, including information that may or may not personally identify you, to third parties to comply with a legal obligation (including, but not limited to, subpoenas); when we believe in good faith that the law requires it; in response to a lawful request by governmental authorities conducting an investigation, including to comply with law enforcement requirements; to verify or enforce our policies and procedures; to respond to an emergency; to prevent or stop activity we may consider to be, or to pose a risk of being, illegal, unethical or legally actionable; or to protect the rights, property, safety, or security of our products and services, Company, third parties, visitors, or the public, as determined by us in our sole discretion.
In other circumstances
We may share information in other circumstances, such as:
	With your employer or other fleet operator or the owner of the Company product, if you do not directly own it and as authorized under applicable law.
...
If you are located in the EEA or Switzerland, we comply with applicable legal requirements for the transfer of personal information to countries outside of the EEA or Switzerland. In particular, Company has certified its adherence to the EU-U.S. Privacy Shield Framework and the Swiss-U.S. Privacy Shield Framework as set forth by the Department of Commerce and the European Commission, and the Swiss Federal Data Protection and Information Commissioner, respectively, with respect to the processing of certain personal information transferred from the EEA and Switzerland to Company and its wholly-owned U.S. subsidiaries. Company’s Privacy Shield Policy is available here. In addition, Company has entered into Standard Contractual Clauses issued by the European Commission where appropriate.
...
Company International B.V. is responsible for processing your personal information. We have appointed a Data Protection Officer, who can be contacted by:
	sending an e-mail to DPO@Company.com;
	writing to Company International B.V., Attn: DPO, 122 Burgemeester Stramanweg, 1101 EN Amsterdam, Netherlands.
Rights and Choices
...
	Disabling the collection of performance data from your Company energy product.
...
	You can access your Company Account to update the information from or about you in that account at any time.
...
If you sell or transfer your Company product to another person, please notify us so that we can determine whether additional steps are required to help safeguard information from or about you from disclosure to the purchaser or transferee of the Company product.
Retention Period
...
Minors
Our products and services are not directed to individuals under the age of sixteen (16), and we request that these individuals not provide any information to Company.
Links
...
	via e‐mail at privacy@Company.com;
	via mail at Company, Inc., Attn: Legal, 45500 Fremont Boulevard, Fremont, California 94538, United States.
...
Company, Inc. and its wholly-owned U.S. subsidiaries (collectively, “Company U.S.”) have subscribed to and will comply with the EU-U.S. Privacy Shield Framework and the Swiss-U.S. Privacy Shield Framework (the “Frameworks”) as set forth by the U.S. Department of Commerce regarding the processing of Personal Information (as defined below) that is transferred from the European Economic Area (“EEA”) and Switzerland to the United States, respectively. Company U.S. has certified to the Department of Commerce that it adheres to the Privacy Shield Principles (the “Principles”). If there is any conflict between this Policy and the Principles, the Principles will govern. To learn more about the Frameworks, and to view our certification, please visit www.privacyshield.gov.
This Privacy Shield Policy supplements our Customer Privacy Policy. Capitalized terms used in this Privacy Shield Policy have the meaning given to them by our Customer Privacy Policy, unless specifically defined in this Policy. This Privacy Shield Policy applies to Company U.S., which is subject to the investigatory and enforcement powers of the Federal Trade Commission.
Personal Information Received from the European Economic Area and Switzerland
Company U.S. may receive from the EEA and Switzerland some or all of the information listed in our Customer Privacy Policy. Some of that information may qualify as “personal information” or “personal data” (collectively, “Personal Information”) as defined in the Principles. To the extent that Company U.S. receives Personal Information from the EEA and Switzerland in reliance on the Frameworks, Company U.S. will handle such Personal Information in accordance with the Principles.
Data Integrity and Purpose Limitation
Company U.S. may use the Personal Information it receives from the EEA and Switzerland for the purposes set forth in our Customer Privacy Policy or as you may otherwise be notified. We take reasonable steps to ensure that the Personal Information we process is reliable for its intended use, accurate, complete, and current to the extent necessary for the purposes for which we use the Personal Information. We will not process Personal Information in a way that is incompatible with the purposes for which it has been collected or subsequently authorized by you. We will adhere to the Principles for as long as we retain the Personal Information collected under the Frameworks.
Onward Transfers
...
Our Customer Privacy Policy sets forth methods by which you may access and/or submit requests to review, correct, update, suppress, or delete information from or about you. Company U.S. will comply with the Principles in its handling of such requests with respect to Personal Information.
...
If an issue cannot be resolved through Company’s internal dispute resolution mechanism, you may submit a complaint, at no cost, which serves as Company’s third-party alternative dispute resolution provider. For claimed violations of the Principles not resolved by these mechanisms, you may be able to invoke binding arbitration as detailed in the Principles.
Contact Information
If you have questions, concerns, or complaints about this Privacy Shield Policy or Company’s privacy practices, please contact us by email at privacy@Company.com or write to us at the following address:
Company, Inc.
...
Company Updates
Company Updates are emails, calls or messages via the Company app (all of them referred to as ‘messages’) that provide more information on Company products, services and regional events. We are requesting this consent on our own behalf and that of our regional subsidiaries. You can withdraw your consent to receive commercial electronic messages at any time by clicking "unsubscribe" at the bottom of these emails or Company app message, or letting our customer representative know about your decision. Some messages directly related to a Company purchase cannot be opted out of.
...
(650) 681-5000
Patent Pledge
On June 12, 2014, Company announced that it will not initiate patent lawsuits against anyone who, in good faith, wants to use its technology. Company was created to accelerate the advent of sustainable transport, and this policy is intended to encourage the advancement of a common, rapidly-evolving platform for electric vehicles, thereby benefiting Company, other companies making electric vehicles, and the world. These guidelines provide further detail as to how we are implementing this policy.
Company’s Pledge
Company irrevocably pledges that it will not initiate a lawsuit against any party for infringing a Company Patent through activity relating to electric vehicles or related equipment for so long as such party is acting in good faith. Key terms of the Pledge are explained below.
Definition of Key Terms
"Company Patents" means all patents owned now or in the future by Company (other than a patent owned jointly with a third party or any patent that Company later acquires that comes with an encumbrance that prevents it from being subject to this Pledge). A list of Company Patents subject to the Pledge will be maintained at the following URL: https://www.Company.com/about/legal#patent-list.
A party is "acting in good faith" for so long as such party and its related or affiliated companies have not:
	asserted, helped others assert or had a financial stake in any assertion of (i) any patent or other intellectual property right against Company or (ii) any patent right against a third party for its use of technologies relating to electric vehicles or related equipment;
	challenged, helped others challenge, or had a financial stake in any challenge to any Company patent; or
	marketed or sold any knock-off product (e.g., a product created by imitating or copying the design or appearance of a Company product or which suggests an association with or endorsement by Company) or provided any material assistance to another party doing so.
Transfer of Company Patents
Should Company ever transfer a Company Patent to a third party, it will do so only to a party that agrees, by means of a public declaration intended to be binding on such party, to provide the same protection that Company provided under the Pledge and to place the same requirement on any subsequent transferee.
Legal Effect
The Pledge, which is irrevocable and legally binding on Company and its successors, is a "standstill," meaning that it is a forbearance of enforcement of Company’s remedies against any party for claims of infringement for so long as such party is acting in good faith. In order for Company to preserve its ability to enforce the Company Patents against any party not acting in good faith, the Pledge is not a waiver of any patent claims (including claims for damages for past acts of infringement) and is not a license, covenant not to sue, or authorization to engage in patented activities or a limitation on remedies, damages or claims. Except as expressly stated in the Pledge, no rights shall be deemed granted, waived or received by implication, exhaustion, estoppel or otherwise. Finally, the Pledge is not an indication of the value of an arms-length, negotiated license or a reasonable royalty.
What this pledge means is that as long as someone uses our patents for electric vehicles and doesn’t do bad things, such as knocking off our products or using our patents and then suing us for intellectual property infringement, they should have no fear of Company asserting its patents against them.
